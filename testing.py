...
wd = webdriver.Chrome(executable_path="C:\Program Files\Python39\Lib\site-packages\chromedriver.exe")
print(wd.title)
...
try:
    ...
    time.sleep(3)
    wd.find_element_by_name('Name').send_keys('Sricharan BEllur')
    time.sleep(3)
    wd.find_element_by_name('Email').send_keys('sricharanbellur@gmail.com')
    time.sleep(3)
